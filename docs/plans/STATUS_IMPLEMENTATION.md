...
- **Refresh token automatique** : Méthodes `refreshAccessToken()` et `getValidAccessToken()` (23 novembre 2025) ✅
...
- Filtres (catégorie, date, **médecin** ✅ 23 novembre 2025)
- **Filtre par médecin** : Dialog de sélection avec liste complète (23 novembre 2025)
