...
- ⚠️ **Build Android** : À recréer (APK nettoyé, guide disponible)
...
**Note** : ⚠️ Le build APK n'existe plus actuellement (probablement nettoyé). À recréer avec `flutter build apk --release`
