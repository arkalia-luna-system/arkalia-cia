...
class _AdvancedSearchScreenState extends State<AdvancedSearchScreen> {
  ...
  bool _useSemanticSearch =
      true; // Activé par défaut pour meilleure qualité de recherche
  ...
  Future<void> _performSearch() async {
    ...
    try {
      final results = await _searchService.search(
        _filters,
        useSemantic: _useSemanticSearch,
      );
      setState(() {
        _results = results;
        _isSearching = false;
              ...
              children: [
                TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    helperText:
                        'Astuce: Utilisez plusieurs mots pour une recherche plus précise',
                    helperMaxLines: 2,
                  ),
          ...
          Padding(
            ...
            child: Wrap(
              ...
              children: [
                ...
                Tooltip(
                  message:
                      'Filtrer par catégorie de document (Ordonnance, Résultat, etc.)',
                  child: FilterChip(
                ...
                Tooltip(
                  message:
                      'Filtrer par type d\'examen (IRM, Scanner, Analyse, etc.)',
                  child: FilterChip(
                ...
                Tooltip(
                  ...
                  child: FilterChip(
                    label: Text(
                      _selectedDoctorId != null && _doctors.isNotEmpty
                          ? (_doctors
                              .firstWhere(
            ...
            child: Row(
              children: [
                Expanded(
                  child: Tooltip(
                    message:
                        'La recherche sémantique comprend le sens des mots et trouve des résultats même avec des synonymes',
            ...
            content: const SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 8),
                  Text(
                    '• Combinez plusieurs filtres pour une recherche précise',
                  ),
                  Text(
                    '• Ex: "IRM" + Médecin + Date = IRM d\'un médecin à une date',
                  ),
                ],
              ),
            ),
