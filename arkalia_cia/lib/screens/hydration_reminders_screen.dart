...
class HydrationRemindersScreen extends StatefulWidget {
  ...
  @override
  State<HydrationRemindersScreen> createState() =>
      _HydrationRemindersScreenState();
}
...
class _HydrationRemindersScreenState extends State<HydrationRemindersScreen>
  ...
  Future<void> _loadData() async {
    ...
    try {
      ...
      final entries = await _hydrationService.getHydrationEntries(
        _selectedDate,
      );
  ...
  void _generateSmartSuggestion(
    ...
    if (percentage >= 100) {
      suggestion =
          '🎉 Excellent ! Vous avez atteint votre objectif aujourd\'hui !';
    } else if (hour < 10 && total < goal * 0.2) {
      suggestion =
          '☀️ Bon matin ! Commencez votre journée avec un verre d\'eau.';
      ...
      suggestion =
          '🌙 Il est temps de compléter votre hydratation quotidienne.';
      ...
      suggestion =
          '💡 Il vous reste environ $glassesNeeded verre${glassesNeeded > 1 ? 's' : ''} à boire aujourd\'hui.';
    }
              ...
              TextButton(
                ...
                style: TextButton.styleFrom(
                  minimumSize: const Size(
                    100,
                    48,
                  ), // Taille minimale pour accessibilité seniors
      ...
      appBar: AppBar(
        ...
        title: const Text(
          ...
          style: TextStyle(
            fontSize: 18,
            fontWeight: FontWeight.bold,
          ), // Taille minimale 18px pour accessibilité seniors
        ),
        actions: [
          IconButton(
        ...
        child: InkWell(
          ...
          child: Container(
            padding: const EdgeInsets.symmetric(
              horizontal: 24,
              vertical: 18,
            ), // Padding augmenté pour accessibilité seniors
            child: Row(
              mainAxisSize: MainAxisSize.min,
              children: [
                Icon(
                ...
                Text(
                  ...
                  style: const TextStyle(
                    ...
                    fontWeight: FontWeight.bold,
                    fontSize:
                        16, // Taille texte minimale 16px pour accessibilité seniors
                  ),
                ),
              ],
            ),
