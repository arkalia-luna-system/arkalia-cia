...
void main() {
  group('RegisterScreen Tests', () {
    testWidgets('Affiche le formulaire d\'inscription', (
      WidgetTester tester,
    ) async {
    ...
    testWidgets('Valide le nom d\'utilisateur (minimum 3 caractères)', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(const MaterialApp(home: RegisterScreen()));
    ...
    testWidgets('Valide le mot de passe (minimum 8 caractères)', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(const MaterialApp(home: RegisterScreen()));
    ...
    testWidgets('Valide la confirmation du mot de passe', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(const MaterialApp(home: RegisterScreen()));
    ...
    testWidgets('Valide le format email si fourni', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(const MaterialApp(home: RegisterScreen()));
    ...
    testWidgets('Affiche le texte d\'aide pour l\'email', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(const MaterialApp(home: RegisterScreen()));
      ...
      expect(
        find.text(
          'Permet la récupération de compte si vous oubliez votre mot de passe',
        ),
        findsOneWidget,
      );
    });
