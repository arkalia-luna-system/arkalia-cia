...
void main() {
  group('HydrationRemindersScreen - Améliorations Accessibilité', () {
    test(
      'Les boutons doivent avoir une taille minimale de 48px pour accessibilité seniors',
      () {
    ...
    test(
      'Les textes doivent avoir une taille minimale de 14px pour accessibilité seniors',
      () {
    ...
    test(
      'Les boutons ElevatedButton doivent avoir foregroundColor défini pour contraste',
      () {
    ...
    test(
      'Les TextButton doivent avoir une taille minimale pour accessibilité',
      () {
  ...
  group('HydrationRemindersScreen - UI Améliorations', () {
    ...
    test(
      'Les icônes doivent avoir une taille minimale de 24px',
      () {
        const iconSize = 24.0;
