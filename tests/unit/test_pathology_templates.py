...
class TestPathologyTemplates:
    ...
    def test_arthritis_templates(self):
        ...
        templates = [
            ...
            },
            {
                'name': 'Arthrite',
                'symptoms': ['Douleurs articulaires', 'Raideur', 'Gonflement'],
                'treatments': ['Anti-inflammatoires', 'Traitements de fond', 'Kinésithérapie'],
            },
            {
                'name': 'Tendinite',
                'symptoms': ['Douleurs articulaires', 'Raideur', 'Gonflement'],
        ...
        for template in templates:
            assert template['name'] in ['Arthrose', 'Arthrite', 'Tendinite', 'Spondylarthrite']
    ...
    def test_all_templates_have_required_fields(self):
        ...
        templates = [
            {'name': 'Endométriose', 'symptoms': [], 'treatments': [], 'exams': [], 'reminders': {}},
            {'name': 'Cancer', 'symptoms': [], 'treatments': [], 'exams': [], 'reminders': {}},
            {'name': 'Myélome', 'symptoms': [], 'treatments': [], 'exams': [], 'reminders': {}},
            {'name': 'Ostéoporose', 'symptoms': [], 'treatments': [], 'exams': [], 'reminders': {}},
            {'name': 'Arthrose', 'symptoms': [], 'treatments': [], 'exams': [], 'reminders': {}},
            {'name': 'Parkinson', 'symptoms': [], 'treatments': [], 'exams': [], 'reminders': {}},
        ]

        for template in templates:
            for field in required_fields:
                assert field in template, f"Champ {field} manquant dans {template['name']}"
